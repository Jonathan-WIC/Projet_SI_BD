...
CREATE TABLE DEALING (
	ID_DEALING INT(10) AUTO_INCREMENT NOT NULL,
	AMOUNT INT(10),
	DEALING_DATE DATETIME,
	ID_JOUEUR INT(10) NOT NULL,
	PRIMARY KEY (ID_DEALING)
);
...
ALTER TABLE SUB_SPECIE ADD CONSTRAINT FK_SUB_SPECIE_ID_SPECIE FOREIGN KEY (ID_SPECIE) REFERENCES SPIECE (ID_SPECIE);
...
ALTER TABLE DEALING ADD CONSTRAINT FK_DEALING_ID_JOUEUR FOREIGN KEY (ID_JOUEUR) REFERENCES PLAYER (ID_JOUEUR);
