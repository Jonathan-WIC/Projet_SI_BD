...
ALTER TABLE MONSTER ADD CONSTRAINT FK_MONSTER_ID_PERSO FOREIGN KEY (ID_PERSO) REFERENCES PERSO (ID_PERSO);
...
ALTER TABLE PTRANSACTION ADD CONSTRAINT FK_PTRANSACTION_ID_PERSO FOREIGN KEY (ID_PERSO) REFERENCES PERSO (ID_PERSO);
...
ALTER TABLE ASSOC_PERSO_ENCLOSURE ADD CONSTRAINT FK_ASSOC_PERSO_ENCLOSURE_ID_PERSO FOREIGN KEY (ID_PERSO) REFERENCES PERSO (ID_PERSO);
...
ALTER TABLE ASSOC_PERSO_QUEST ADD CONSTRAINT FK_ASSOC_PERSO_QUEST_ID_PERSO FOREIGN KEY (ID_PERSO) REFERENCES PERSO (ID_PERSO);
