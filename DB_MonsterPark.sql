...
CREATE TABLE LOG_CONNEXION (
    ...
    ID_PERSO INT(10) NOT NULL,
	DATE_CONNEXION DATETIME,
    PRIMARY KEY (ID_ACCOUNT, ID_PERSO)
);
...
CREATE TABLE ASSOC_PERSO_ENCLOSURE (
	...
	ID_PERSO INT(10) NOT NULL,
	PRIMARY KEY (ID_ENCLOSURE, ID_PERSO)
);
...
CREATE TABLE ASSOC_PERSO_QUEST (
	ID_QUEST INT(10) NOT NULL,
	ID_PERSO INT(10) NOT NULL,
	ASSOC_PERSO_QUEST_COST INT(10),
	PRIMARY KEY (ID_QUEST, ID_PERSO)
);
...
INSERT INTO `ACCOUNT` (`ID_ACCOUNT`, `GENDER`, `BIRTH_DATE`, `PHONE_NUMBER`, `DESCRIPTION`, `WEBSITE`, `PSEUDO`, `EMAIL`, `PASSWORD`, `IP`, `DATE_INSCRIPTION`, `DATE_CONNEXION`) VALUES
(1, '1994-06-22', 'F', '0123456789', 'Ma petite chérie d''amour!!!!! <3<3<3<3<<3', NULL, 'titi', 'chevals@poney.unicorn', 'oui', 'non', '2015-01-01 04:24:07', '2015-02-02 19:10:02');

INSERT INTO `PERSO` (`ID_PERSO`, `FIRST_NAME`, `LAST_NAME`, `GENDER`, `MONEY`, `ID_ACCOUNT`) VALUES
...
INSERT INTO `MONSTER` (`ID_MONSTER`, `NAME`, `GENDER`, `AGE`, `WEIGHT`, `DANGER_SCALE`, `HEALTH_STATE`, `HUNGER_STATE`, `CLEAN_SCALE`, `REGIME`, `ID_SUB_SPECIE`, `ID_ENCLOSURE`, `ID_MATURITY`, `ID_PERSO`) VALUES
