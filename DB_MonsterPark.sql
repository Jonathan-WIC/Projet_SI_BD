...
CREATE TABLE HABITAT (
    ID_HABITAT INT(10) AUTO_INCREMENT NOT NULL,
...
ALTER TABLE SUB_SPECIE ADD CONSTRAINT FK_SUB_SPECIE_ID_HABITAT FOREIGN KEY (ID_HABITAT) REFERENCES HABITAT (ID_HABITAT);
...
INSERT INTO `HABITAT` (`ID_HABITAT`, `LIB_HABITAT`) VALUES
(1, 'JUNGLE'),
(2, 'OCEAN'),
(3, 'PLAINE'),
(4, 'CITY'),
...
INSERT INTO `SUB_SPECIE` (`ID_SUB_SPECIE`, `LIB_SUB_SPECIE`, `ID_SPECIE`, `ID_HABITAT`) VALUES
(1, 'WYVERN_AVIAIRE', 1, 1),
(2, 'WYVERN_AQUA', 1, 2),
(3, 'WYVERN_VOLANT', 1, 3),
(4, 'FELYNE', 3, 4),
(5, 'MELYNX', 3, 5),
...
INSERT INTO `MATURITY` (`ID_MATURITY`, `MATURITY_LEVEL`, `LIB_MATURITY`) VALUES
(1, 1, 'EGG'),
(2, 7, 'ADULT');
