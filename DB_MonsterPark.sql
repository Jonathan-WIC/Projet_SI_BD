...
DROP TABLE IF EXISTS ASSOC_MONSTER_SUB_SPECIE ;
CREATE TABLE ASSOC_MONSTER_SUB_SPECIE (
	ID_SUB_SPECIE INT(10) AUTO_INCREMENT NOT NULL,
...
ALTER TABLE ASSOC_MONSTER_SUB_SPECIE ADD CONSTRAINT FK_ASSOC_MONSTER_SUB_SPECIE_ID_SUB_SPECIE FOREIGN KEY (ID_SUB_SPECIE) REFERENCES SUB_SPECIE (ID_SUB_SPECIE);
ALTER TABLE ASSOC_MONSTER_SUB_SPECIE ADD CONSTRAINT FK_ASSOC_MONSTER_SUB_SPECIE_ID_MONSTER FOREIGN KEY (ID_MONSTER) REFERENCES MONSTER (ID_MONSTER);
