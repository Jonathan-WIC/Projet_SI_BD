...
ALTER TABLE PARK ADD CONSTRAINT FK_PARK_ID_PLAYER FOREIGN KEY (ID_PLAYER) REFERENCES PLAYER (ID_PLAYER);
ALTER TABLE PLAYER ADD CONSTRAINT FK_PLAYER_ID_ACCOUNT FOREIGN KEY (ID_ACCOUNT) REFERENCES ACCOUNT (ID_ACCOUNT);
...
INSERT INTO `ACCOUNT` (`ID_ACCOUNT`, `PSEUDO`, `EMAIL`, `PASSWORD`, `IP`, `DATE_INSCRIPTION`, `DATE_CONNEXION`) VALUES
(1, 'titi', 'chevals@poney.unicorn', 'oui', 'non', '2015-01-01 04:24:07', '2015-02-02 19:10:02');

INSERT INTO `PLAYER` (`ID_PLAYER`, `FIRST_NAME`, `LAST_NAME`, `GENDER`, `BIRTH_DATE`, `PHONE_NUMBER`, `DESCRIPTION`, `WEBSITE`, `MONEY`, `ID_ACCOUNT`) VALUES
(1, 'Cathy', 'Farrahi', 'F', '1994-06-22', '0123456789', 'Ma petite chérie d''amour!!!!! <3<3<3<3<<3', NULL, 1000000, 1);
...
INSERT INTO `MONSTER` (`ID_MONSTER`, `NAME`, `GENDER`, `AGE`, `WEIGHT`, `DANGER_SCALE`, `HEALTH_STATE`, `HUNGER_STATE`, `CLEAN_SCALE`, `REGIME`, `ID_SUB_SPECIE`, `ID_ENCLOSURE`, `ID_MATURITY`, `ID_PLAYER`) VALUES
(1, 'Cathy', 'F', 20, 47, 'MORTAL', 100, 100, 100, 'CARNIVORE', 1, NULL, 2, 1);
