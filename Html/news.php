...
<div class="col-md-offset-2 col-md-8" style="margin-top:2%;">
	...
	<div id="optionNews">
		...
		<button id="addNewspaper">Add Newspaper</button>
				...
				<div class="modal-body">
                    ...
                    <form class="form-horizontal">
						<div class="control-group">
							<label class="control-label" for="alterResume">Résumé :</label>
							<div class="controls">
								<textarea type="datetime" name="alterResume" id="alterResume" rows="10" cols="70">
								</textarea>
							</div>
						</div>
					</form>
